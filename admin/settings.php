                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade <?php if($tab === 'footer') echo 'show active'; ?>">
                                <form method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="footer_icp_beian" class="form-label">ICP备案号</label>
                                            <input type="text" class="form-control" id="footer_icp_beian" name="footer_icp_beian" value="<?php echo htmlspecialchars($allSettings['footer_icp_beian'] ?? ''); ?>">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="footer_gongan_beian" class="form-label">公网安备号</label>
                                            <input type="text" class="form-control" id="footer_gongan_beian" name="footer_gongan_beian" value="<?php echo htmlspecialchars($allSettings['footer_gongan_beian'] ?? ''); ?>">
                                        </div>
                                        <div class="col-md-6 mb-3">
